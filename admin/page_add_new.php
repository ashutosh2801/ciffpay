...
if(isset($_POST['title']) && !empty($_POST['title'])) 
{
	extract($_POST);
  $slug = slug($title);
	$sql = "INSERT INTO `tbl_pages` (`title`,`slug`,`content`,`title_fr`,`content_fr`,`created_at`) VALUES( '$title','$slug','$content','".date('Y-m-d H:i:s')."' )"; //exit;
	try {
		if ($conn->query($sql) === TRUE) {
			header('Location: page_edit.php?uid='.$conn->insert_id.'&msg=Record added!');
			exit;
		}
...
<html lang="en">                    
<head>
<title>Add New Pages :: <?php echo SITENAME; ?></title>
...
<div class="wthree_agile_admin_info">
        ...
        <div class="inner_content_w3_agile_info two_in">
            <h2 class="w3_inner_tittle">Add New Pages</h2>
                      ...
                      <div class="form-body">
                          ...
                          <h2>English</h2>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control1" id="content" name="content" placeholder="Content"><?php echo $row->content; ?></textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label for="title" class="col-sm-2 control-label">Title</label>
                              <div class="col-sm-6">
                                <input type="text" required="true" class="form-control1" name="title_fr" placeholder="Title" value="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="content" class="col-sm-2 control-label">Content</label>
                              <div class="col-sm-10">
                                <textarea class="form-control1" id="content_fr" name="content_fr" placeholder="Content"></textarea>
                              </div>
                            </div>
