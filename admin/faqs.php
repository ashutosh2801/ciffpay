...
<html lang="en">
<head>
<title>FAQs :: <?php echo SITENAME; ?></title>
...
<div class="wthree_agile_admin_info">
    ...
    <div class="inner_content">
      ...
      <div class="inner_content_w3_agile_info two_in">
        <h2 class="w3_inner_tittle">FAQs <span>«</span> <a href="faq_add_new.php" class="btn btn-success">Add New</a></h2>
        <!-- tables -->
        <?php
        ...
        <div class="agile-tables">
          <div class="w3l-table-info agile_info_shadow">
            ...
            <div class="row">
              <div class="col-md-3">
                <input type="text" name="q" placeholder="e.g. Title, Content etc" autocomplete="off" value="<?php echo isset($_GET['q'])?$_GET['q']:''?>" />
              </div>              
              <div class="col-md-3">
            ...
            <table id="table"  class="table">
              ...
              $sql = "SELECT * FROM `tbl_faqs` $condition";
              ...
              ?>
                <tr bgcolor="#d4e8d4">
                  ...
                  <td>
                  	<a href="faq_edit.php?id=<?php echo $row->id; ?>" class="badge badge-primary"><i class="fa fa-pencil"></i> Edit</a>
