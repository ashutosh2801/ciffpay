...
if(isset($_GET['uid']) && ($_GET['act']=='delete')) {
	$sql = "DELETE FROM `tbl_pages` WHERE id=".$_GET['uid'].";";
	$conn->query($sql);
...
<html lang="en">
<head>
<title>Pages :: <?php echo SITENAME; ?></title>
...
<div class="wthree_agile_admin_info">
    ...
    <div class="inner_content">
      ...
      <div class="inner_content_w3_agile_info two_in">
        <h2 class="w3_inner_tittle">Pages <a href="page_add_new.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a></h2>
        <!-- tables -->
        <?php
        ...
        <div class="agile-tables">
          <div class="w3l-table-info agile_info_shadow">
            ...
            <table id="table"  class="table">
              ...
              $sql = "SELECT * FROM `tbl_pages` $condition order by title";
              ...
              ?>
                <tr bgcolor="#d4e8d4">
                  ...
                  <td>
                  	<a href="page_edit.php?uid=<?php echo $row->id; ?>" class="badge badge-primary"><i class="fa fa-pencil"></i> Edit</a>
